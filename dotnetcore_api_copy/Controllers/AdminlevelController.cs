    ...
    public class AdminlevelController : BaseController
    {
        ...
        public dynamic AddAdminLevel([FromBody] Newtonsoft.Json.Linq.JObject param)
        {
          /*   var objstr = HttpContext.Request.Form["formDataObj"];
            ...
            if (objAdminlevel != null)
            {
                ...
                _repositoryWrapper.AdminLevel.UpdateAdminLevel(objAdminlevel);
                _repositoryWrapper.EventLog.UpdateEventLog("Update Admin Level", objAdminlevel);
            }
            else
            {
                ...
                _repositoryWrapper.AdminLevel.AddAdminLevel(newobj);
                AdminLevelID = newobj.AdminLevelID;
                _repositoryWrapper.EventLog.InsertEventLog("Add Admin Level", newobj);
            }
           ...
           var objAdminMenuList = (string)obj.adminMenuList;
            ...
            if (objAdminMenuList.Length > 0)
            {
                ...
                if (arr_AdminMenu.Length > 0)
                {
                   ...
                   // _repositoryWrapper.EventLog.InsertEventLog("Add Admin Level", newlist);
                }
            }
        ...
        public dynamic DeleteAdminLevel(int AdminLevelID )
        {
            ...
            if (userresult != null)
            {
                ...
                if (objAdminlevel != null)
                {
                    _repositoryWrapper.AdminLevel.DeleteAdminLevel(objAdminlevel);
                    retBool = true;
                    _repositoryWrapper.EventLog.DeleteEventLog("Delete Admin Level", objAdminlevel);
                }
            }
            dynamic objresponse = new { data = retBool };
            return objresponse;
