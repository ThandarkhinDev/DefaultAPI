    ...
    public class PublicController : BaseController
    {
        ...
        public dynamic UnLock()
        {
            ...
            if(AccountType == 1)//admin
            {
                try
                {
                    var objAdmin = _repositoryWrapper.Admin.FindByID(int.Parse(AccountID));
                    if (objAdmin != null)
                    {                 
                        ...
                        _repositoryWrapper.EventLog.UpdateEventLog("Admin Un-Block", objAdmin);
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    _repositoryWrapper.EventLog.ErrorEventLog("Admin Un-Block", logmsg);
                    returnval = false;
                }
            } 
            else
        ...
        public dynamic resetpassword([FromBody] Newtonsoft.Json.Linq.JObject param)
        {
            ...
            var objAdmin = _repositoryWrapper.Admin.FindByID(accountID);
            dynamic objresponse;
            ...
            {                
                ...
                _repositoryWrapper.EventLog.UpdateEventLog("Admin Change Password From Forgot Password", objAdmin);
