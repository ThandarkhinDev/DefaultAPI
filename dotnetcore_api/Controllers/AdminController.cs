...
namespace MFI
{
    ...
    public class AdminController : BaseController
    {
        ...
        public dynamic GetAdminSetup(int AdminID)
        {
            ...
            var mainQuery = _repositoryWrapper.Admin.GetAllAdmin();
            if (AdminID != 0)
            {
               mainQuery = mainQuery.Where(x => x.AdminID == AdminID);
            }
        ...
        {
            var adminLevel = _repositoryWrapper.AdminLevel.GetAllAdminLevel();
        ...
        public dynamic AddAdminSetup([FromBody] Newtonsoft.Json.Linq.JObject param)
        {
            ...
            if (objAdmin != null)
            {
                ...
                _repositoryWrapper.Admin.UpdateAdmin(objAdmin);
                _repositoryWrapper.EventLog.UpdateEventLog("Update Admin", objAdmin);
            }
            else
            {
                ...
                else
                {
                    ...
                    newobj.Salt = salt;
                    _repositoryWrapper.Admin.AddAdmin(newobj);
                    AdminID = newobj.AdminID;
                }
                _repositoryWrapper.EventLog.InsertEventLog("Add Admin", newobj);
            }
        ...
        public dynamic ResetPassword(int AdminID)
        {
            ...
            if (objAdmin != null)
            {
                ...
                if (Password != "" && Password.Length >= int.Parse(pwdlength))
                {
                    ...
                    _repositoryWrapper.EventLog.InfoEventLog("Reset the Password of Admin", "Success");
            ...
            if (Password.ToString().Length >= int.Parse(pwdlength))
            {
                ...
                if (objAdmin != null)
                {
                    ...
                    if (flag)
                    {
                        ...
                        _repositoryWrapper.EventLog.InfoEventLog("Admin Change Password", "Success");
        ...
        public dynamic unBlock(int AdminID)
        {
            ...
            if (objAdmin != null)
            {
                ...
                _repositoryWrapper.Admin.UpdateAdmin(objAdmin);
                objresponse = new { data = true };
                _repositoryWrapper.EventLog.InfoEventLog("Admin Un-Block", "Success");
            }
            else
                objresponse = new { data = false };
            return objresponse;
        ...
        public dynamic DeleteAdminSetup(int AdminID)
        {
            ...
            else
            {
                ...
                if (objAdmin != null)
                {
                    _repositoryWrapper.Admin.DeleteAdmin(objAdmin);
                    retBool = true;
                    _repositoryWrapper.EventLog.DeleteEventLog("Delete Admin", objAdmin);
                }
            }
