...
namespace MFI.Repository
{
    ...
    public class EventLogRepository : RepositoryBase<EventLog>, IEventLogRepository
    {
        ...
        public void Insert(string Source, dynamic obj)
        {
            obj.SetToString();
            string LogMessage = "";
        ...
        public void Update(string Source, dynamic obj)
        {
            obj.SetToString();
            string LogMessage = "";
        ...
        public void Delete(string Source, dynamic obj)
        {
            obj.SetToString();
            string LogMessage = "";
        ...
        public void Error(string Source, string LogMessage)
        {
            AddEventLog(EventLogType.Error, Source, LogMessage);
        }

        public void Info(string Source, string LogMessage)
        {
            AddEventLog(EventLogType.Info, Source, LogMessage);
        }
   
        public void Warning(string Source, string LogMessage)
        {
